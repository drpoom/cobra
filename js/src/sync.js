...
import {
    ...
    SPI_BUS_0, SPI_BUS_1, SPI_SPEED_1MHZ, SPI_SPEED_10MHZ,
...
export class CobraBridge {
    ...
    async spiWrite(csLine, regAddr, data, speed = SPI_SPEED_1MHZ, mode = SPI_MODE_0) {
    ...
    async spiRead(csLine, regAddr, length, speed = SPI_SPEED_1MHZ, mode = SPI_MODE_0) {
     ...
     * @returns {number} Status byte (0 = success)
     */
    async configSpiBus(bus = SPI_BUS_0, mode = SPI_MODE_0, speed = SPI_SPEED_1MHZ) {
