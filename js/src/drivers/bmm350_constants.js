/**
 * COBRA BMM350 Sensor Constants — JavaScript
 *
 * AUTO-GENERATED from core/sensors/bmm350.json.
...
export const BMM350_DATA_LEN = 12; // bytes per sample
export const BMM350_SPI_READ_CMD = 0x80;
export const BMM350_SPI_WRITE_CMD = 0x00;
